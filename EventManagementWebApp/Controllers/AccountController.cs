...
using EventManagementWebApp.Filters;
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    new UserProfileManager().InsertNewUser(model.FirstName, model.LastName, string.Empty, model.UserName, model.EmailAddress, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, "Staff", true, model.Password);
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    EventManagementWebApp.Models.UserProfile user = db.UserProfiles.FirstOrDefault(u => u.UserName.ToLower() == model.UserName.ToLower());
                    // Check if user already exists
                    if (user == null)
                    {
                        // Insert name into the profile table
                        db.UserProfiles.Add(new EventManagementWebApp.Models.UserProfile { UserName = model.UserName });
                        db.SaveChanges();
